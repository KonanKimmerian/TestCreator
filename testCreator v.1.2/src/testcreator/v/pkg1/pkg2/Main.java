 ...
 */
package testcreator.v.pkg1.pkg2;
...
//        }
        ...
        int result=JOptionPane.showConfirmDialog(frame,new String[]{"текст теста записан в: D:\\"+fileNameValue+".doc.","текст ответов записан в: D:\\"+fileNameValue+"(answers).doc.","Открыть файлы?"},"Расположение текста теста",JOptionPane.YES_NO_OPTION);
        
        if(result==JOptionPane.YES_OPTION){
            try {
                Desktop.getDesktop().open(new File("D:\\"+fileNameValue+".doc"));
                Desktop.getDesktop().open(new File("D:\\"+fileNameValue+"(answers).doc"));
...
//            a=Integer.parseInt(str);
    ...
    public static void saveLevel(String name,ArrayList<String>noname) {
        File Platforms = new File(("C:\\" + name + ".doc"));//создали файл
